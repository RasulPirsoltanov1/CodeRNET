...
namespace EF_Core_Task__.Models
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<Kategorityalar> Kategorityalars { get; set; } = null!;
        ...
        public virtual DbSet<TestInto> TestIntos { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=DESKTOP-NG2G057;Database=Northwind2;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Kategorityalar>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("KATEGORITYALAR");
            ...
            modelBuilder.Entity<TestInto>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("test_into");
